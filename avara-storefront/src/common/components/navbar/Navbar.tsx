      ...
      <div className="flex items-center justify-between px-8 py-4">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-1 cursor-pointer">
            <HiOutlineHeart className="w-6 h-6 text-gray-500" />
            <span className="text-xs text-gray-500">3 Items</span>
            <span className="font-semibold text-gray-900 ml-1">Wishlist</span>
          </div>
          <Link href="/cart" className="flex items-center gap-1 cursor-pointer relative">
            <HiOutlineShoppingCart className="w-6 h-6 text-gray-500" />
            <span className="text-xs text-gray-500">{cartState.totalItems} Items</span>
